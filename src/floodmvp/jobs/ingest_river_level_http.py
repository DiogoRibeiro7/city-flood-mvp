...
async def run() -> int:
    parser = argparse.ArgumentParser(description="Ingest river level telemetry from HTTP")
    ...
    parser.add_argument("--metric", default="water_level_m")
    parser.add_argument("--units", default="m", choices=["m", "cm", "mm", "ft", "in"])
